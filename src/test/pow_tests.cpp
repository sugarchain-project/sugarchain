...
// BOOST_AUTO_TEST_CASE(BTCget_next_work)
// {
//     const auto chainParams = CreateChainParams(CBaseChainParams::MAIN);
...
//     BOOST_CHECK_EQUAL(BTC_CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, chainParams->GetConsensus()), 0x1d00d86aU);
// }
// 
// /* Test the constraint on the upper bound for next work */
// BOOST_AUTO_TEST_CASE(BTCget_next_work_pow_limit)
// {
//     const auto chainParams = CreateChainParams(CBaseChainParams::MAIN);
...
//     pindexLast.nBits = 0x1d00ffff;
//     // BOOST_CHECK_EQUAL(BTC_CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, chainParams->GetConsensus()), 0x1d00ffffU);
//     BOOST_CHECK_EQUAL(BTC_CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, chainParams->GetConsensus()), 486650628);
// }
// 
// /* Test the constraint on the lower bound for actual time taken */
// BOOST_AUTO_TEST_CASE(BTCget_next_work_lower_limit_actual)
// {
//     const auto chainParams = CreateChainParams(CBaseChainParams::MAIN);
...
//     BOOST_CHECK_EQUAL(BTC_CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, chainParams->GetConsensus()), 0x1c0168fdU);
// }
// 
// /* Test the constraint on the upper bound for actual time taken */
// BOOST_AUTO_TEST_CASE(BTCget_next_work_upper_limit_actual)
// {
//     const auto chainParams = CreateChainParams(CBaseChainParams::MAIN);
...
//     BOOST_CHECK_EQUAL(BTC_CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, chainParams->GetConsensus()), 0x1d00e1fdU);
// }

BOOST_AUTO_TEST_CASE(BTCGetBlockProofEquivalentTime_test)
{
    const auto chainParams = CreateChainParams(CBaseChainParams::MAIN);
