...
BOOST_FIXTURE_TEST_SUITE(miner_tests, TestingSetup)
    ...
    struct
    {
        ...
        unsigned int nonce;
            ...
            // {4, 0xc65555d5}, {2, 0x11140080}, {1, 0xdd5e5555}, {1, 0xa7070000}, 
            // {2, 0xab080080}, {2, 0xfe020080}, {1, 0x84000000}, {2, 0xbf605555}, 
            // {2, 0x2cafaa2a}, {1, 0xa3585555}, {1, 0xffaaaaaa}, {2, 0xb2adaa2a}, 
            // {2, 0xefb0aa2a}, {1, 0x7a050000}, {2, 0x61030080}, {2, 0x6b5b55d5}, 
            // {1, 0x40040000}, {2, 0xaeaeaa2a}, {1, 0xf2020080}, {1, 0x67040080}, 
            // {3, 0x80070080}, {2, 0xa7adaaaa}, {2, 0x365d5555}, {1, 0xa25e55d5}, 
            // {2, 0x915a5555}, {1, 0xa45f5555}, {2, 0xeb0e0000}, {2, 0x42615555}, 
            // {2, 0xa1000000}, {2, 0xd020000},  {2, 0x34abaaaa}, {2, 0xed5a5555}, 
            // {1, 0x875d5555}, {2, 0xceaaaa2a}, {2, 0x98000080}, {1, 0xd5c55d5}, 
            // {2, 0xec5555d5}, {1, 0x2595555},  {2, 0xd6b7aa2a}, {1, 0x68020080}, 
            // {1, 0x31b0aaaa}, {3, 0xd565555},  {2, 0xc35c55d5}, {5, 0xec040000}, 
            // {1, 0x595b55d5}, {5, 0xe1b0aaaa}, {1, 0xcf565555}, {1, 0xb9020000}, 
            // {1, 0xb5aaaa2a}, {2, 0x565955d5}, {1, 0x13010080}, {1, 0x6e000000}, 
            // {1, 0x305855d5}, {1, 0xe30a0080}, {5, 0xa1beaaaa}, {5, 0xc3010000}, 
            // {1, 0xb70d0000}, {1, 0xefafaaaa}, {6, 0xe2565555}, {2, 0x7595555}, 
            // {2, 0xa3080000}, {1, 0xbbaaaa2a}, {1, 0x6e040080}, {1, 0x39abaaaa}, 
            // {2, 0x806255d5}, {2, 0xa0adaaaa}, {1, 0xcfadaaaa}, {1, 0x275755d5}, 
            // {1, 0xe4aeaa2a}, {5, 0xc55f5555}, {5, 0x6aabaa2a}, {1, 0xfeacaa2a}, 
            // {1, 0x1cb2aa2a}, {2, 0x31060000}, {2, 0x27000080}, {1, 0x3fb1aa2a}, 
            // {2, 0x6e555555}, {1, 0x41000080}, {2, 0x91adaa2a}, {2, 0x105755d5}, 
            // {1, 0x77645555}, {1, 0x5ab0aa2a}, {1, 0xb6585555}, {5, 0xd05955d5}, 
            // {1, 0x53575555}, {1, 0x6f5a5555}, {1, 0x15acaa2a}, {1, 0x7db0aa2a}, 
            // {1, 0x6d5a55d5}, {1, 0xae5555d5}, {1, 0x7c010080}, {2, 0x82afaaaa}, 
            // {0, 0xeb595555}, {1, 0xf75555d5}, {2, 0xa8040080}, {2, 0x465e5555}, 
            // {2, 0xd5adaaaa}, {1, 0x15000080}, {1, 0x270a0000}, {1, 0x46030080}, 
            // {1, 0x615e5555}, {1, 0xf3000080}, {1, 0x985655d5}, {5, 0xf2050000}, 
            // {2, 0xe45755d5}, {1, 0x3fadaaaa}, {1, 0x55020080}, {1, 0xfeb7aaaa}, 
            // {2, 0x85b1aaaa}, {2, 0xa1030000},
    };
    ...
    BOOST_AUTO_TEST_CASE(createnewblock_validity_test)
    {
        ...
        auto chainParams = CreateChainParams(CBaseChainParams::REGTEST);
...
//	}
        ...
        while (chainActive.Tip()->nHeight < (210000*120)-1) // 120x bitcoin // 210000 * 120 = 25200000
        {
        ...
        while (chainActive.Tip()->nHeight < 210000*120) // 60x bitcoin // 210000 * 120 = 25200000
        {
            CBlockIndex *prev = chainActive.Tip();
            CBlockIndex *next = new CBlockIndex();
            next->phashBlock = new uint256(InsecureRand256());
