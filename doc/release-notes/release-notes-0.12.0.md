...
Then, to tunnel a SSL connection on 28332 to a RPC server bound on localhost on port 17978 do:

    stunnel -d 28332 -r 127.0.0.1:17978 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ProxyPass http://127.0.0.1:7978/
        ProxyPassReverse http://127.0.0.1:7978/
